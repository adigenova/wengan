package Wengan::Pipeline::WenganD;

=head1 NAME

Wengan::Pipeline::WenganD

=head1 DESCRIPTION

This Module load the WenganD pipeline implemented by the Wengan assembler.
...
my @tools_name=("Wengan::Bruijn::Disco","Wengan::Mapper::FMS","Wengan::Chimeric::IM","Wengan::Mapper::FML","Wengan::SSG::LG");
